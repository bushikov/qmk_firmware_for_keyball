...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    LAYOUT_universal(
        ...
        XXXXXXX  , XXXXXXX  , XXXXXXX  , XXXXXXX  , XXXXXXX  , XXXXXXX  ,                                  XXXXXXX  , XXXXXXX  ,KC_MY_BTN4,KC_MY_BTN5, XXXXXXX  , XXXXXXX  ,
        XXXXXXX  , XXXXXXX  , XXXXXXX  , XXXXXXX  , XXXXXXX  , XXXXXXX  ,                                  XXXXXXX  ,KC_MY_BTN1,KC_MY_BTN3,KC_MY_BTN2, XXXXXXX  , XXXXXXX  ,
        XXXXXXX  , XXXXXXX  , XXXXXXX  , XXXXXXX  , XXXXXXX  , XXXXXXX  , XXXXXXX  ,            XXXXXXX  , XXXXXXX  ,KC_MY_SCR , XXXXXXX  , XXXXXXX  , XXXXXXX  , XXXXXXX  ,
