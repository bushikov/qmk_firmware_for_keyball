...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    LAYOUT_universal(
        ...
        _______, LCTL_T(KC_EQL), KC_LBRC, KC_SLSH, KC_MINS, KC_INT1, KC_SCLN, KC_QUOT, KC_RBRC, KC_NUHS, KC_INT3, _______,
        _______, LSFT_T(KC_PLUS), KC_LCBR, KC_QUES, KC_UNDS, LSFT(KC_INT1), KC_COLN, KC_DQUO, KC_RCBR, LSFT(KC_NUHS), LSFT(KC_INT3),  _______,
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______
    ),

    LAYOUT_universal(
        _______, KC_EXLM, KC_AT, KC_HASH, KC_DLR, KC_PERC, KC_CIRC, KC_AMPR, KC_ASTR, KC_LPRN, LGUI(KC_INT3),  _______,
        _______, KC_PLUS, KC_LCBR, KC_QUES, KC_UNDS, LSFT(KC_INT1), KC_COLN, KC_DQUO, KC_RCBR, LSFT(KC_NUHS), LSFT(KC_INT3),  _______,
        _______, KC_LSFT, KC_LGUI, KC_LALT, KC_LNG2, KC_LSFT, KC_SPC, KC_LNG1, _______, _______, KC_DEL,  _______,
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______
    ),

    LAYOUT_universal(
        _______, KC_ESC, KC_TAB, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_UP, KC_NO, KC_NO, _______,
        _______, KC_LCTL, _______, KC_QUES, KC_EXLM, KC_NO, KC_NO, KC_LEFT, KC_DOWN, KC_RGHT, KC_NO, _______,
        _______, KC_LSFT, KC_LGUI, KC_LALT, KC_LNG2, _______, KC_NO, KC_LNG1, KC_NO, KC_NO, KC_DEL, _______,
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______
    ),

    LAYOUT_universal(
        _______, KC_NO, KC_TAB, KC_NO, KC_NO, KC_F1, KC_F2, KC_F3, KC_F4, KC_F5, KC_F6, _______,
        _______, KC_NO, KC_NO, KC_NO, KC_NO, KC_F7, KC_F8, KC_F9, KC_F10, KC_F11, KC_F12, _______,
        _______, KC_LSFT, KC_NO, KC_NO, KC_NO, _______, _______, _______, KC_NO, MO(5), MO(6), _______,
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______
    ),

    LAYOUT_universal(
        _______, RGB_TOG, RGB_MOD, RGB_HUI, RGB_SAI, RGB_VAI, CPI_I100, CPI_D100, KC_TO_CLICKABLE_INC, KC_TO_CLICKABLE_DEC, KC_NO, KBC_SAVE,
        _______, RGB_M_P, RGB_M_B, RGB_M_R, RGB_M_SW, RGB_M_SN, CPI_I1K, CPI_D1K, KC_NO, KC_NO, KC_NO, KBC_RST,
        _______, RGB_M_K, RGB_M_X, RGB_M_G, KC_NO, KC_NO, QK_BOOT, KC_NO, KC_NO, KC_NO, KC_NO, _______,
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______
    ),

    LAYOUT_universal(
        XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, KC_TO_CLICKABLE_INC, KC_TO_CLICKABLE_DEC, KC_MY_BTN4, KC_MY_BTN5, XXXXXXX, KC_SCROLL_DIR_V,
        XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, KC_MY_BTN1, KC_MY_BTN3, KC_MY_BTN2, KC_MY_SCR, XXXXXXX,
